...
class _MyPage2State extends State<Page2> with WidgetsBindingObserver {
  ...
  final List<int> notificationNumbers =
      List<int>.generate(MAX_NUM_NOTIFICATIONS, (k) => k + 1);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Table(
          ...
          children: [
            TableRow(children: [
              Column(children: [SizedBox(height: widthBetweenRows)]),
              Column(children: [SizedBox(height: widthBetweenRows)]),
            ]),
            TableRow(decoration: boxDeco, children: [
              Column(
                children: [
                  Align(
                      alignment: Alignment.centerLeft,
                      child: Text('Notifications per day',
            ...
            TableRow(decoration: boxDeco, children: [
              Column(
                children: [
                  Align(
                      alignment: Alignment.centerLeft,
                      child: Text('Earliest notification',
                          style: TextStyle(color: Colors.white, fontSize: 18))),
                ],
              ),
              Column(mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              Column(
                children: [
                  Align(
                      ...
                      child: Text('Latest notification',
                          style: TextStyle(color: Colors.white, fontSize: 18))),
                ],
              ),
              Column(children: [
                ...
                children: [
                  ElevatedButton(
                    ...
                    onPressed: () async {
                      ...
                      setState(() {
                        areScheduled = (areScheduledInternal != null)
                            ? areScheduledInternal
                            : false;
                      });
                    },
